...
namespace PLDNaturales\Client\Interceptor;
...
use \PLDNaturales\Client\Interceptor\KeyHandler;
use \PLDNaturales\Client\Interceptor\MyLogger;
use \PLDNaturales\Client\Model\Errors;
use \PLDNaturales\Client\Model\Error;

class MiddlewareEvents
{
    
    function __construct(\PLDNaturales\Client\Interceptor\KeyHandler $signer)
    {
        $this->signer = $signer;
...
function build_error($code, $message){
    $error = new \PLDNaturales\Client\Model\Error([
        "code" => $code,
        "message" => $message
    ]);
    $errors = new \PLDNaturales\Client\Model\Errores(["errors" => [$error]]);
